...
{
    public class EndIndexResolver : IValueResolver<ChannelMetadataRecord, ChannelMetaDataVM, IndexData_VM>
	{
		...
		public IndexData_VM Resolve(ChannelMetadataRecord source, ChannelMetaDataVM destination, IndexData_VM member, ResolutionContext context)
		{
			...
			member.IndexValue = source.EndIndex.HasValue ? source.EndIndex.Value : 0;
